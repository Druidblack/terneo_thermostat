...
from .const import DOMAIN, MANUFACTURER, ControlType, SENSOR_TYPES, ParamNum
...
def get_control_type_options(thermostat: TerneoThermostat) -> list[str]:
    ...
    if thermostat.supports_parameter(ParamNum.MANUAL_AIR):
...
SELECT_REQUIRED_PARAMS = {
    "control_type": ParamNum.CONTROL_TYPE,
    "sensor_type": ParamNum.SENSOR_TYPE,
}
...
async def async_setup_entry(
    ...
    for description in SELECT_DESCRIPTIONS:
        required = SELECT_REQUIRED_PARAMS.get(description.key)
