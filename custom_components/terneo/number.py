...
from homeassistant.const import EntityCategory, UnitOfTemperature, UnitOfPower, UnitOfTime
from homeassistant.core import HomeAssistant, callback
from homeassistant.helpers.entity_platform import AddEntitiesCallback
from homeassistant.helpers.update_coordinator import CoordinatorEntity

from .const import DOMAIN, MANUFACTURER, ParamNum
...
NUMBER_REQUIRED_PARAMS = {
    "brightness": ParamNum.BRIGHTNESS,
    "hysteresis": ParamNum.HYSTERESIS,
    "floor_correction": ParamNum.FLOOR_CORRECTION,
    "air_correction": ParamNum.AIR_CORRECTION,
    "prop_koef": ParamNum.PROP_KOEF,
    "upper_floor_limit": ParamNum.UPPER_LIMIT,
    "lower_floor_limit": ParamNum.LOWER_LIMIT,
    "upper_air_limit": ParamNum.UPPER_AIR_LIMIT,
    "lower_air_limit": ParamNum.LOWER_AIR_LIMIT,
    "min_temp_advanced": ParamNum.MIN_TEMP_ADVANCED,
    "max_temp_advanced": ParamNum.MAX_TEMP_ADVANCED,
    "ble_sensor_interval": ParamNum.BLE_SENSOR_INTERVAL,
    "upper_warning_temp": ParamNum.UPPER_WARNING_TEMP,
    "lower_warning_temp": ParamNum.LOWER_WARNING_TEMP,
    "power": ParamNum.POWER,
    "night_bright_start": ParamNum.NIGHT_BRIGHT_START,
    "night_bright_end": ParamNum.NIGHT_BRIGHT_END,
    "button_minus_cor": ParamNum.BUTTON_MINUS_COR,
    "button_menu_cor": ParamNum.BUTTON_MENU_COR,
    "button_plus_cor": ParamNum.BUTTON_PLUS_COR,
    "away_floor_temperature": ParamNum.AWAY_FLOOR,
    "away_air_temperature": ParamNum.AWAY_AIR,
}
...
async def async_setup_entry(
    ...
    for description in NUMBER_DESCRIPTIONS:
        required = NUMBER_REQUIRED_PARAMS.get(description.key)
        if required is not None and not thermostat.supports_parameter(required):
            continue
...
class TerneoNumberEntity(CoordinatorEntity, NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        await async_execute_command(
            ...
            self._thermostat,
            value,
            action=f"set {self.entity_description.name or self.entity_description.key}",
        )
