...
# cmd:4 is lightweight status telemetry and can be polled frequently.
DEFAULT_SCAN_INTERVAL = 10
# cmd:1 returns the full parameter set and is intentionally polled much less often.
DEFAULT_PARAMETERS_SCAN_INTERVAL = 120
PARAMETERS_RETRY_INTERVAL = 30
# Embedded Terneo HTTP servers can occasionally respond slowly.
DEFAULT_TIMEOUT = 7
REQUEST_RETRIES = 1
REQUEST_RETRY_DELAY = 0.35
